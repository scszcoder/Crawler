...
def save_last_names_to_file(lns):
    fname = 'C:/CrawlerData/names/fn_' + lns[len(lns)-2] + '_' + lns[len(lns)-1] + '_' + lns[0] + '_.csv'
...
def get_last_last_name():
    ...
    if len(nfiles) > 0:
        ...
        with open(fname, 'r') as read_obj:
            ...
            last_last = [csv_reader[len(csv_reader)-2], csv_reader[len(csv_reader)-1]]
